...
#include "ros2_interfaces/srv/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros2_interfaces::srv::Control_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interfaces::srv::Control_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Control_Request(full_bounded, 0);
}
...
{
  return &ros2_interfaces::srv::typesupport_fastrtps_cpp::_Control_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const ros2_interfaces::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_interfaces::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Control_Response(full_bounded, 0);
}
...
{
  return &ros2_interfaces::srv::typesupport_fastrtps_cpp::_Control_Response__handle;
}
...
{
  return &ros2_interfaces::srv::typesupport_fastrtps_cpp::_Control__handle;
}
