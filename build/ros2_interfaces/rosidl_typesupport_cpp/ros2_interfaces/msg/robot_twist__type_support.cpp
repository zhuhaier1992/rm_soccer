...
static const _RobotTwist_type_support_symbol_names_t _RobotTwist_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interfaces, msg, RobotTwist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces, msg, RobotTwist)),
  }
};
...
{
  return &::ros2_interfaces::msg::rosidl_typesupport_cpp::RobotTwist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_interfaces, msg, RobotTwist)() {
  return get_message_type_support_handle<ros2_interfaces::msg::RobotTwist>();
}
