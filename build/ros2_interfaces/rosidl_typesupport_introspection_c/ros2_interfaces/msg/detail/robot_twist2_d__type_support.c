...
size_t RobotTwist2D__rosidl_typesupport_introspection_c__size_function__Pose2D__twist(
...
const void * RobotTwist2D__rosidl_typesupport_introspection_c__get_const_function__Pose2D__twist(
...
void * RobotTwist2D__rosidl_typesupport_introspection_c__get_function__Pose2D__twist(
...
bool RobotTwist2D__rosidl_typesupport_introspection_c__resize_function__Pose2D__twist(
...
static rosidl_typesupport_introspection_c__MessageMember RobotTwist2D__rosidl_typesupport_introspection_c__RobotTwist2D_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(ros2_interfaces__msg__RobotTwist2D, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    NULL,  // default value
    RobotTwist2D__rosidl_typesupport_introspection_c__size_function__Pose2D__twist,  // size() function pointer
    RobotTwist2D__rosidl_typesupport_introspection_c__get_const_function__Pose2D__twist,  // get_const(index) function pointer
    RobotTwist2D__rosidl_typesupport_introspection_c__get_function__Pose2D__twist,  // get(index) function pointer
    RobotTwist2D__rosidl_typesupport_introspection_c__resize_function__Pose2D__twist  // resize(index) function pointer
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_interfaces, msg, RobotTwist2D)() {
  ...
  RobotTwist2D__rosidl_typesupport_introspection_c__RobotTwist2D_message_member_array[1].members_ =
