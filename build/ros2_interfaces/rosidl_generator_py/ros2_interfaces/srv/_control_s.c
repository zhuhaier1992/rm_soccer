...
bool ros2_interfaces__srv__control__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.srv._control.Control_Request", full_classname_dest, 44) == 0);
  }
  ros2_interfaces__srv__Control_Request * ros_message = _ros_message;
  {  // id
...
PyObject * ros2_interfaces__srv__control__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces.srv._control");
...
ROSIDL_GENERATOR_C_EXPORT
bool ros2_interfaces__srv__control__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.srv._control.Control_Response", full_classname_dest, 45) == 0);
  }
  ros2_interfaces__srv__Control_Response * ros_message = _ros_message;
  {  // status
    PyObject * field = PyObject_GetAttrString(_pymsg, "status");
    if (!field) {
      return false;
