...
bool ros2_interfaces__msg__robot_twist__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.msg._robot_twist.RobotTwist", full_classname_dest, 43) == 0);
  }
  ros2_interfaces__msg__RobotTwist * ros_message = _ros_message;
  {  // twist
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ros2_interfaces__msg__robot_twist__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RobotTwist */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces.msg._robot_twist");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotTwist");
  ...
  ros2_interfaces__msg__RobotTwist * ros_message = (ros2_interfaces__msg__RobotTwist *)raw_ros_message;
  {  // twist
    PyObject * field = NULL;
