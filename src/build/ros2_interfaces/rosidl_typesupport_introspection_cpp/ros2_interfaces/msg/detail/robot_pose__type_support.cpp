...
{
  new (message_memory) ros2_interfaces::msg::RobotPose(_init);
}

void RobotPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interfaces::msg::RobotPose *>(message_memory);
  typed_message->~RobotPose();
}

size_t size_function__RobotPose__pose(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<geometry_msgs::msg::Pose2D> *>(untyped_member);
  return member->size();
}

const void * get_const_function__RobotPose__pose(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__RobotPose__pose(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__RobotPose__pose(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<geometry_msgs::msg::Pose2D> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotPose_message_member_array[1] = {
  {
    "pose",  // name
    ...
    offsetof(ros2_interfaces::msg::RobotPose, pose),  // bytes offset in struct
    nullptr,  // default value
    size_function__RobotPose__pose,  // size() function pointer
    get_const_function__RobotPose__pose,  // get_const(index) function pointer
    get_function__RobotPose__pose,  // get(index) function pointer
    resize_function__RobotPose__pose  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotPose_message_members = {
  ...
  1,  // number of fields
  sizeof(ros2_interfaces::msg::RobotPose),
...
{
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces, msg, RobotPose)() {
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotPose_message_type_support_handle;
}
